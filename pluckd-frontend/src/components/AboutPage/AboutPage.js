          ...
          <section className="about-section">
            ...
            <div className="content-wrapper">
              <p className="about-text">
                PluckD was born from the belief that every pre-loved item has a story worth continuing. 
                In a world of endless consumption, we're creating a space where handpicked treasures 
                find new homes and new purposes.
              </p>
              <p className="about-text">
                Our platform connects mindful consumers who understand that the most beautiful finds 
                are often the ones with history. Every swap, every exchange, every "pluck" is a step 
                toward a more sustainable future.
              </p>
              <p className="about-text">
                Because when you pluck it, swap it, and love it — you're not just finding something 
                special, you're becoming part of a community that values quality over quantity, 
                story over newness.
              </p>
            </div>
          </section>
